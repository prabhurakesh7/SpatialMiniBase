...
public class Utility implements Catalogglobal
{
	...
	public static void insertRecordUT(String relation, int attrCnt,
	        attrNode[] attrList) throws Catalogmissparam, Catalogrelexists,
	        Catalogdupattrs, Catalognomem, IOException, Catalogioerror,
	        Cataloghferror, Catalogrelnotfound, Catalogindexnotfound,
	        Catalogattrnotfound, Catalogbadattrcount, Catalogattrexists,
	        Catalogbadtype, Exception
	{
	...
	public static void insertRecUT(String relation, int attrCnt,
	        attrNode[] attrList) throws Catalogmissparam, Catalogrelexists,
	        Catalogdupattrs, Catalognomem, IOException, Catalogioerror,
	        Cataloghferror, Catalogrelnotfound, Catalogindexnotfound,
	        Catalogattrnotfound, Catalogbadattrcount, Catalogattrexists,
	        Catalogbadtype, Exception
	{
		...
		attrCount = ExtendedSystemDefs.MINIBASE_ATTRCAT.getRelInfo(relation,
		        attrCount, attrRecs);
		...
		indexCount = ExtendedSystemDefs.MINIBASE_INDCAT.getRelInfo(relation,
			...
			switch (attrRecs[i].attrType.attrType)
				{
					...
					case (AttrType.attrString):
						tuple.setStrFld(attrRecs[i].attrPos,
		...
		{
			indexName = ExtendedSystemDefs.MINIBASE_INDCAT.buildIndexName(
			        relation, indexRecs[i].attrName, //
			...
			switch (attrType.attrType)
				{
					...
					case AttrType.attrReal:
						...
						IntegerKey k2 = new IntegerKey((int) floatVal); // no
						                                                // FloatKey
						key = k2;
						break;
