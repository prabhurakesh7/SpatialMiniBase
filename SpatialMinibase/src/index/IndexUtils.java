		...
		switch (type.attrType)
			{
				...
				case AttrType.attrSpatialGeometry:
					...
					if (choice == 1)
					{
						operand1[0] = cd.operand1.double_array[0];
						operand1[1] = cd.operand1.double_array[1];
						operand1[2] = cd.operand1.double_array[2];
						operand1[3] = cd.operand1.double_array[3];
					}
					else
					{
						operand1[0] = cd.operand2.double_array[0];
						operand1[1] = cd.operand2.double_array[1];
						operand1[2] = cd.operand2.double_array[2];
						operand1[3] = cd.operand2.double_array[3];
					}
					
					return new MBRKey(operand1);
				case AttrType.attrReal:
					/*
					 * // need FloatKey class in bt.java
					 * if (choice == 1) return new FloatKey(new
