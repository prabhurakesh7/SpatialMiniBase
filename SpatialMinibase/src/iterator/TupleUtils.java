		...
		switch (fldType.attrType)
			{
				...
				case AttrType.attrString: // Compare two strings
					...
					// Now handle the special case that is posed by the
					// max_values for strings...
				...
				case AttrType.attrSpatialGeometry:
					try
					{
						t2_d = t2.getDoubleArrayFld(t2_fld_no);
						t1_d = t1.getSpatialGeometryFld(3).getMBRIndexKey();
					}
					catch (FieldNumberOutOfBoundException e)
					{
						throw new TupleUtilsException(e,
