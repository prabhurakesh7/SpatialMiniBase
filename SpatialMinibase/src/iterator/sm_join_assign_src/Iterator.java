...
public abstract class Iterator implements Flags
{
	 ...
	 * it is set to true the first time the <code>close()</code> function is
	 * called.
	 ...
	 *                other exceptions
	 */
	public abstract Tuple get_next() throws IOException, JoinsException,
	 ...
	 */
	public abstract void close() throws IOException, JoinsException,
	        SortException, IndexException;
