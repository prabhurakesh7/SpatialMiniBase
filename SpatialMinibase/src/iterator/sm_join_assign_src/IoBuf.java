...
public class IoBuf implements GlobalConst
{
	...
	private boolean         dirty;           // Does this buffer contain dirty
											  // pages?
	private int             t_per_pg, // # of tuples that fit in 1 page
	        t_in_buf;                        // # of tuples that fit in the
											  // buffer
	...
	private byte            _bufs[][];       // Array of pointers to buffer
											  // pages.
	...
	private boolean         flushed;         // TRUE => buffer has been
											  // flushed.
	private int             mode;
	private int             t_rd_from_pg;    // # of tuples read from current
											  // page
	private SpoofIbuf       i_buf;           // gets input from a temporary
											  // file
}
